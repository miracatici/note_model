...
pitch = json.load(open("PostFilterTest/01_taksim_-_kanuni_haci_arif_bey.json", 'r'))['pitch']
tonic_identifier = TonicLastNote()
tonic, pitch, pitch_chunks, distribution, sp = tonic_identifier.identify(pitch)
tonicHz = tonic["value"]
recDatas = mmb.getAudioMetadata("PostFilterTest/01_taksim_-_kanuni_haci_arif_bey.mp3")
